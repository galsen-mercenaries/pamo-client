...
export class PatientService {
  ...
  getUserFicheMedical(user: UserModel) {
    return this.http.get<FicheMedicalModel>(`${USERS_RESOURCES}/${user.userId}/${USER_FICHE_MEDICAL_INFOS_RESOURCES}`);
  }
  saveFicheMedicalInfos(user: UserModel, ficheInfos: FicheMedicalModel) {
    return this.http.post<FicheMedicalModel>(`${USERS_RESOURCES}/${user.userId}/${USER_FICHE_MEDICAL_INFOS_RESOURCES}`, ficheInfos)
  }

  updateFicheMedicalInfos(user: UserModel, ficheInfos: FicheMedicalModel) {
    return this.http.patch<FicheMedicalModel>(`${USERS_RESOURCES}/${user.userId}/${USER_FICHE_MEDICAL_INFOS_RESOURCES}`, ficheInfos)
  }
}
